...
<div class="header_user_info pull-right">
	<div data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-cog"></i><span>{l s='Top links' mod='blockuserinfo'} </span></div>	
		...
		<li class="last">
			<a href="{$link->getPageLink(order, true)|escape:'html':'UTF-8'}" title="{l s='Checkout' mod='blockuserinfo'}" class="last"><i class="fa fa-share"></i>{l s='Checkout' mod='blockuserinfo'}</a></li>
