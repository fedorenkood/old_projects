...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2018 at 10:26 PM
...
INSERT INTO `registration` (`id`, `lead`, `school`, `grade`, `phone`, `email`, `task`, `first_par`, `second_par`, `third_par`, `fourth_par`) VALUES
...
(27, 'Выаы Ывафы Ыва', 'ыфыыыыыыыыыы', '1-4', '+38 (555) 555-5555', 'sada@sfg.dfaeef', 'ыфваыфвафыва', 'Фываыф Ываыва Ывафва', 'Ыфвафыва Ыфвафыв Ывафывафы', '', '');
