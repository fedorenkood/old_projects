...
Class PMS_Emails {
    ...
    static function init() {
        ...
        add_action( 'pms_member_subscription_inserted', array( 'PMS_Emails', 'send_emails' ), 10, 2 );
        add_action( 'pms_member_subscription_updated',  array( 'PMS_Emails', 'send_emails' ), 10, 2 );
     ...
     *
     */
    static function send_emails( $subscription_id = 0, $subscription_data = array() ) {
