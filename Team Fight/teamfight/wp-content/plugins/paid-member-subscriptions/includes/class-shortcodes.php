    ...
    public static function member_account( $atts ) {
        ...
        if( ! $member->is_member() ) {
            ...
            if( ! empty( $_GET['subscription_id'] ) ) {
                ...
                // Output the details of a member's subscription
                ...
                // Output all subscriptions for current member
                include 'views/shortcodes/view-shortcode-account.php';
       ...
       // if( $atts['show_edit_profile'] && empty( $_GET['subscription_id'] ) )
